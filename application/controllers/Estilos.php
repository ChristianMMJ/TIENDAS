    ...
    public function onAgregar() {
        try {
            ...
            $data = array(
                ...
                'Loc1' => ($this->input->post('Loc1') !== NULL && $this->input->post('Loc1') !== 'null') ? $this->input->post('Loc1') : NULL,
                'Loc2' => ($this->input->post('Loc2') !== NULL && $this->input->post('Loc2') !== 'null') ? $this->input->post('Loc2') : NULL,
                'Loc3' => ($this->input->post('Loc3') !== NULL && $this->input->post('Loc3') !== 'null') ? $this->input->post('Loc3') : NULL,
