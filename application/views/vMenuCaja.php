<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="<?php print base_url(); ?>"><span class="fa fa-cut"></span> Caja</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php print base_url('CortesCaja') ?>"><span class="fa fa-cut"></span> Corte de Caja <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php print base_url('Diversos') ?>"><span class="fa fa-people-carry"></span> Movimientos Diversos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php print base_url('ReportesCaja') ?>"><span class="fa fa-file-pdf"></span> Reportes</a>
            </li> 
        </ul>
