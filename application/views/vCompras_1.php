        ...
        <div class="card-block">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div id="Compras" class="table-responsive">
                    <table id="tblCompras" class="table table-hover table-sm  compact" style="width:100%">
                        <thead>
                            <tr> 
                                <th scope="col">ID</th>
...
<script>
    ...
    var nuevo = true;
    var Compras, tblCompras = pnlTablero.find("#tblCompras");
    /*DATATABLE GLOBAL*/
    ...
    function getRecordsX() {
        ...
        Compras = tblCompras.DataTable({
            ...
            "columns": [
                ...
                {"data": "Estatus"}, {"data": "Tienda"},
                {"data": "Fecha"}, {"data": "Usuario"}
            ],
            "columnDefs": [
                {
                    "targets": [0],
