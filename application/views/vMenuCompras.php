<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="<?php print base_url(); ?>"><span class="fa fa-shopping-cart"></span> Compras</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php print base_url('Compras') ?>"><span class="fa fa-shopping-basket"></span> Gestión de compras <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php print base_url('ReportesCompras') ?>"><span class="fa fa-file-pdf"></span> Reportes</a>
            </li>
        </ul>
