    ...
    <div class="card-body">
        ...
        <div class="card-block">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div id="Tiendas" class="table-responsive">
                    <table id="tblTiendas" class="table table-hover table-sm  compact" style="width:100%">
                        <thead>
                            <tr> 
                                <th scope="col">ID</th>
...
<script>
    ...
    var nuevo = true;
    var Tiendas, tblTiendas = pnlTablero.find("#tblTiendas");
    ...
    function getRecordsX() {
        ...
        tblTiendas.find('tbody').on('dblclick', 'tr', function () {
            temp = Tiendas.row($(this)).data().ID;
            if (temp) {
                nuevo = false;
                HoldOn.open({
                    theme: "sk-bounce",
