            ...
            <form id="frmNuevo">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        <input type="text" class="form-control form-control-sm" maxlength="60"  id="Estado" name="Estado"  >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <input type="number" class="form-control form-control-sm"  maxlength="8"  id="CP" name="CP"  >
                    </div>
                    <div class="col-sm">
                        <label for="Telefono">Teléfono</label>  
                        <input type="tel" class="form-control form-control-sm"  maxlength="15"  id="Teléfono" name="Teléfono"  >
                    </div>
                    <div class="col-sm">
                        <label for="Estatus">Estatus*</label>
                        <select class="form-control form-control-sm-lg"  name="Estatus" required=""> 
                            <option value=""></option>  
