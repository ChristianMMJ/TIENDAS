<div class="col-12">
    <div id="MnuBlock" class="col-12 row justify-content-center mt-2" align="center">
        <!--REGISTRAR VENTA-->
        <div class="card special-card m-3" onclick="onLoadMenuOption('CortesCaja')">
            <div class="card-body ">
                <span class="fa fa-cut fa-2x mt-5"></span>  
            </div>
            <div class="card-footer special-card-footer bg-transparent">CORTE DE CAJA</div>
        </div>
        <!--DEVOLUCIONES-->
        <div class="card special-card m-3" onclick="onLoadMenuOption('Diversos')">
            <div class="card-body ">
                <span class="fa fa-people-carry fa-2x mt-5"></span>  
            </div>
            <div class="card-footer special-card-footer bg-transparent">MOVIMIENTOS DIVERSOS</div>
        </div>
        <!--REPORTES-->
        <div class="card special-card m-3" onclick="onLoadMenuOption('ReportesCaja')">
            <div class="card-body ">
