        ...
        <div class="card-block">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div id="Clientes" class="table-responsive">
                    <table id="tblClientes" class="table table-hover table-sm  compact" style="width:100%">
                        <thead>
                            <tr> 
                                <th scope="col">ID</th>
...
<script>
    ...
    var nuevo = true;
    var Clientes, tblClientes = pnlTablero.find("#tblClientes");
    ...
    function getRecordsX() {
        ...
        tblClientes.find('tbody').on('dblclick', 'tr', function () {
            temp = Clientes.row($(this)).data().ID;
            if (temp) {
                nuevo = false;
                HoldOn.open({
                    theme: "sk-bounce",
