<div class="col-12">
    <div id="MnuBlock" class="col-12 row justify-content-center mt-2" align="center">
        <!--GESTIÓN DE COMPRAS-->
        <div class="card special-card m-3" onclick="onLoadMenuOption('Compras')">
            <div class="card-body ">
                <span class="fa fa-shopping-basket fa-2x mt-5"></span>  
            </div>
            <div class="card-footer special-card-footer bg-transparent">GESTIÓN DE COMPRAS</div>
        </div>
        <!--REPORTES-->
