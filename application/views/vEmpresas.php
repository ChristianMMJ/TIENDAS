    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6 float-left">
                <legend class="float-left">Gestión de Empresas</legend>
            </div>
...
<script>
    ...
    function getRecords() {
        ...
        $.ajax({
            ...
            var thead = $('#tblEmpresas thead th');
            var tfoot = $('#tblEmpresas tfoot th');
            thead.eq(0).addClass("d-none");
            tfoot.eq(0).addClass("d-none");
            $.each($.find('#tblEmpresas tbody tr'), function (k, v) {
                var td = $(v).find("td");
            ...
            $('#tblEmpresas tbody').on('click', 'tr', function () {
                $("#tblEmpresas tbody tr").removeClass("success");
